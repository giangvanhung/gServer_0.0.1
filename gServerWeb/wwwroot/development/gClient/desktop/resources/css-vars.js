...
__rt_setDynamic("$accent-color", __rt_getGlobalDefault("$accent_color") || __ColorRGBA.fromHex("#FFFF00"), 11);
__rt_setDynamic("$accent-light-color", __rt_getGlobalDefault("$accent_light_color") || __ColorRGBA.fromHex("#00FF00"), 12);
...
__rt_setDynamic("$reverse-background-color", __rt_getGlobalDefault("$reverse_background_color") || __ColorRGBA.fromHex("#39a1f4"), 35);
